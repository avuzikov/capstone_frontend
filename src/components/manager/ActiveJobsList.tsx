    ...
    <div className="card-bordered">
      ...
      <div className="mt-4 flex justify-between">
        <button
          ...
          className={`bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-md ${currentPage === 1 ? 'bg-gray-500 cursor-not-allowed' : ''}`}
        >
          Previous
        </button>
        <button
          ...
          className={`bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-md ${currentPage === Math.ceil(jobs.length / jobsPerPage) ? 'bg-gray-500 cursor-not-allowed' : ''}`}
        >
          Next
        </button>
      </div>
