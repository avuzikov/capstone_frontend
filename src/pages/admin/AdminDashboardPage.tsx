    ...
    <>
      <div className="flex flex-col gap-4 p-large">
        ...
        <div className="flex gap-4">
          <AdminDashboardCard title="Applicant List" link="/admin/applicants">
            <svg
          ...
          <AdminDashboardCard title="Manager List" link="/admin/managers">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <AdminDashboardCard title="Applicant List" link="/admin/tables">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
