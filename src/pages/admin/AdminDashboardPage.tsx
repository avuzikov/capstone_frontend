    ...
    <>
      <div className="flex flex-col gap-3 p-large">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <AdminDashboardCard title="Jobs" link="/admin/jobs">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}className="size-12 stroke-adp-navy">
