...
export let jobs: Job[] = [
  ...
  },
  {
    ...
    jobDescription:
      "We are seeking a passionate junior developer to join our engineering team...",
...
export let applications: Application[] = [
  ...
  },
  {
    ...
    coverLetter:
      "As an experienced product manager, I am thrilled to apply for this role...",
    customResume:
  ...
  },
  {
    ...
    applicationStatus: "pending",
    coverLetter:
      "I believe my skills in marketing would be a great fit for this position...",
    customResume:
